        ...
        <Box flex={1} backgroundColor="$blue400" justifyContent="center">
            ...
            <Box shadowColor="$black" shadowOffset={{ width: 0, height: 2 }} shadowOpacity={"$25"} shadowRadius={"$3.5"} elevation={"$5"} backgroundColor="$white" borderRadius={"$md"} marginTop={"$10"} marginHorizontal={"$6"} p={"$5"} >
                ...
                <FormControl>
                    ...
                    <Input label="No. Handphone" keyboardType="phone-pad" value={null} onChangeText={() => {}} height={"$10"} />
                    <Input label="Password" secureTextEntry value={null} onChangeText={() => {}} height={"$10"} />
                </FormControl>
                <Box flexDirection="column" my={"$5"}>
                    <Button title="Register" type="text" icon="submit" padding={"$3"} fontSize={"$md"} onPress={() => { navigation.navigate("Login"); }} />
                </Box>
            </Box>
        </Box>
    );
